(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/comp/SeatControl.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '316f8nhmO5LEbFoxObKpigy', 'SeatControl', __filename);
// scripts/comp/SeatControl.js
...
cc.Class({
    ...
    initTempDate: function initTempDate() {},
    ...
    initView: function initView() {
        ...
        for (var _i = 0; _i < playerList.length; _i++) {
            var index = cc.vv.gameNetMgr.getLocalIndex(_i);
            var set = self.seats[index].getComponent("Seat");
            self._seats.push(set);
            set.setUserInfo(playerList[_i]);
            self.seats[index].active = true;
        };
        cc.vv.gameNetMgr.seats = self._seats;
    },

    initSeatCard: function initSeatCard(uid) {
        var self = this;
        var playerList = cc.vv.gameNetMgr.playerList;
        for (var i = 0; i < playerList.length; i++) {
    ...
    showZhuanAni: function showZhuanAni(target, data) {
        var self = this;
        var uid = parseInt(data.uid);
    ...
    showDealZhuanAni: function showDealZhuanAni(data) {
        var self = this;
    ...
    ShowUserCards: function ShowUserCards(target, data) {
        var self = this;
        var uid = parseInt(data.uid);
        var localIndex = cc.vv.gameNetMgr.getSeatIndexByID(uid);
        var card = self._cards[localIndex];
    ...
    ShowScore: function ShowScore(target, data) {
        var self = this;
    ...
    // 显示分数，金币动画没有加
    ShowCoinAnimation: function ShowCoinAnimation(target, data) {
        var self = this;
        var zhuanUid = -1;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=SeatControl.js.map
